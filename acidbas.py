...
while True:
    ...
    titraty=input()
    print("fort ou faible?  ex. faible")
    strength=input()
    print("volume dans ml?   ex. 25")
    volume=(float(input()))/1000
    print("Concentration molaire?  ex. 0.5")
    intmolarity=float(eval(input()))
    
    if strength=="faible":
        if titraty=="acid":
            print("Constant d'acidité Ka?  ex. 6.6*10**-6")
        if titraty=="base":
            print("Constant de base Kb?  ex. 6.6*10**-6")
        kvalue=(input())
        kvalue=eval(kvalue)
        ...
        #print("kvalue =",kvalue)
    if titraty=="acid":
        print("Volume de base fort ajouté?")
    else:
        print("Volume de acid fort ajouté?")
    vol2=input()
    vol2=float(vol2)/1000
    print("Concentration molaire de solution titré?")
    molarity2=input()
